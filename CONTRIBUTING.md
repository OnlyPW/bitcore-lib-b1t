...
We're working hard to make *bitcore* the most powerful JavaScript library for working with B1T. Our goal is to have *bitcore* be a library that can be used by anyone interested in B1T, and to level expertise differences with great design and documentation.
